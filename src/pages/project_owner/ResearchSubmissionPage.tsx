          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value="NCKH-2023-0142" readOnly className="w-full rounded-xl border-slate-200 text-sm bg-slate-50 py-2.5" />
              </div>
              <div>
        ...
        {step === 3 && (
          <div className="p-6 space-y-6">
            ...
            <div className="flex justify-between">
              ...
              <button onClick={() => alert('Kết quả nghiên cứu đã được nộp thành công!')} className="px-8 py-2.5 text-sm font-bold text-white bg-green-600 rounded-xl hover:bg-green-700">✓ NỘP KẾT QUẢ NGHIÊN CỨU</button>
            </div>
          </div>
        )}
      </div>
